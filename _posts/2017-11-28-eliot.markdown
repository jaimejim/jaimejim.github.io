...
image: /assets/images/eliot.webp
tag:
  - Emulation
  - Docker
  - LWM2M
...
![Hardware gallore!](/assets/images/devices.webp)*By the time you read this another hardware platform would have appeared*
...
![ELIOT Stack](/assets/images/eliotstack.webp)*In ELIOT we emulate CoAP, LwM2M and a generate simple device logic*
